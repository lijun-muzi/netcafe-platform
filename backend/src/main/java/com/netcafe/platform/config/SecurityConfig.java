  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.GET, "/kiosk/machines/*/overview").permitAll()
            .requestMatchers(HttpMethod.POST, "/kiosk/sessions/start").permitAll()
            .requestMatchers(HttpMethod.GET, "/kiosk/sessions/**").hasRole("USER")
            .requestMatchers(HttpMethod.POST, "/kiosk/sessions/pause").hasRole("USER")
            .requestMatchers(HttpMethod.POST, "/kiosk/sessions/end").hasRole("USER")
            ...
            .requestMatchers(HttpMethod.POST, "/machine-templates").hasRole("SUPER_ADMIN")
            .requestMatchers(HttpMethod.PUT, "/machine-templates/*").hasRole("SUPER_ADMIN")
            .requestMatchers(HttpMethod.DELETE, "/machine-templates/*").hasRole("SUPER_ADMIN")
            ...
            .requestMatchers("/session-orders/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
